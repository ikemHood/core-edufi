...
class userServices {
    ...
    async updateUser(searchData: Partial<IUser>, updates: Partial<IUser>): Promise<IUser> {
    ...
    async findUsers(searchData: Partial<IUser>, pagination: number = 0, limit: number = 20): Promise<IUser[]> {
        const filter = cleanFilterQuery({ ...searchData });
