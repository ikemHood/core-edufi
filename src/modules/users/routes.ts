...
export default (app: Elysia) =>
   app
      ...
      .get('/api/v1/auth/password/:email/forget', controller.forgetPass, {
         params: 'email',
      })
      .post('/api/v1/auth/password/:email/validate', controller.validateOTP, {
         params: 'email',
         body: 'otp',
      })
      .post('/api/v1/auth/password/:email/reset', controller.resetPass, {
         params: 'email',
         body: 'resetPass',
      });
...
export const userRoutes = (app: Elysia) =>
   app
      ...
      .get('/api/v1/watchlist/:id', controller.addToWatchlist, {
         params: 'courseId',
      });
